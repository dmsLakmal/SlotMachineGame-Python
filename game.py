...
def deposit():
    while True:
        amount = input("Enter amount you want enter: $")
        if amount.isdigit():
            amount = int(amount)
            if amount > 0:
                break
    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 1 <= lines <= MAX_LINES:
                ...
                print(f"You should enter number between 1 to {MAX_LINES}")
        else:
    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if MIN_BET <= amount <= MAX_BET:
                ...
                print(f"Please enter bet between ${MAX_BET} - ${MIN_BET}")
        else:
...
def main():
    ...
    while True:
        ...
        answer = input("Press enter t play (q to quit).")
        if answer == "q":
            break
